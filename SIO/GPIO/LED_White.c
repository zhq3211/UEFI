...
//
//	功能:
//		设置 Power Button LED 为白色灯。
//
//	HW 电路：
//		电路图上，表面上控制黄/白的是 GP10 和 GP41;
//		其实，使用了 “Power LED Backup Plan”，实际是由 GP45 和 GP41 控制！
//		---------------------+--------------+-------------			
//		GP45 (Pin57,RTC_DET#)|	H	|	H	|	L	|	L
//		---------------------+------+-------+-------------	
//		GP41 (Pin59,5V_LED)	 |	H	|	L	|	L	|	H
//		---------------------+------+-------+-------+-----	
//							 |  黄	|	灭	| 【白】|	灭
//		---------------------+------+-------+-------+-----	
//
...
//				High/Low:		BaseAddress=62h-63h，Index=03h<1>=0	(Low)
//		
//	程序流程：
...
void GP41(UINT16 BaseAddress){
	...
	//4. Low：BaseAddress+0x03，bit<1>=0
